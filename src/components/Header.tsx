    ...
    <header className="flex items-center justify-between py-6">
      <Link href="/" className="flex items-center space-x-3">
        <Image
          ...
          className="min-w-9"
        />
        <span className="hidden sm:block text-2xl font-medium text-primary dark:text-secondary">
          FillMyWallet
        </span>
      </Link>
      <div className="relative w-96 mx-4">
        <div className="relative">
          ...
          <Input
            ...
            className="pl-10 border-primary focus-visible:ring-0 placeholder:text-muted-foreground/60"
            value={searchTerm}
